...
categories:
  - 前端
date: 2019-12-16 11:21:00
---
# 写在前面

<font color= hotpink> Read the fucking source code! </font>

很久没有更新博文了，最近赶着六七个课设。。。<br>
从零上手Flask框架，终于算是把MIS课设给做好了－－基于Flask框架的教务管理系统。

# 心路历程
一开始一直在纠结是使用java开发好还是使用python开发好，以至于一段时间内踌躇不定。后来发现貌似python Flask框架要简单的多。于是乎，上手干。<br>
之前没有接触过前端的知识，就连http的状态码我都不知道2333，于是上网找demo，学基础，学html、学js、学web知识...<br>
好在之前对python也算是有过几次开发经验，上手并不算的上太难。但是一开始就把我难住了！***<font color=red>MIS该怎么分析与设计？</font>*** 无从知道，因为前期上课就没怎么听。。。
经过一番瞎操作，算是完成了任务吧。后期会总结一下。

# 新的知识
这次开发我学到了一些新的知识：Ajax技术（JQuery）、ORM模型开发、Flask框架、echarts、layui的使用。

## Ajax异步数据请求
所谓Ajax，就是**<font color=red>Asynchronous Javascript And XML（异步javascript和XML）</font>**,我的理解是，<font color=hotpink>***在不重载或者部分重载页面的情况下对页面的内容进行更新。</font>***<br>
一开始也是一脸无奈，后来看了下官方的文档，学了一下，算是简单的使用了吧。代码如下：

1. 前端
```
$.ajax({
  url: 't_notice',	// 这里写接收数据的url　
  type: 'POST',		// post get 都支持
  data: JSON.stringify(insert_data),	// 用　json数据格式
  dataType: 'json',
  contentType: 'application/json',		//一定要设置
...
***<font color=blue>这个目前还不了解，先不说。</font>***


## Flask前端框架
发现挺好用，万年jsp终于可以不用了。<br>
demo程序如下：
```
...
<body>
    ...
    <div id="main" style="width: 1300px;height:750px;"></div>
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
	<div class="layui-logo">BUG教务系统</div>
	<ul class="layui-nav layui-layout-left">
	  <li class="layui-nav-item">
          <a href="javascript:;">通知公告</a>
          <dl class="layui-nav-child">
            <dd><a href={{ url_for('t_notice') }}>公告管理</a></dd>
            <dd><a href="">申诉管理</a></dd>
          </dl>
      </li>

	  <li class="layui-nav-item"><a href="">选课系统</a></li>
	  <li class="layui-nav-item"><a href="">毕设系统</a></li>
	  <li class="layui-nav-item"><a href= {{ url_for('t_charts') }} >用户画像</a></li>
	...
	<ul class="layui-nav layui-layout-right">
	  ...
	  <li class="layui-nav-item"><a href={{ url_for('signout') }}>退了</a></li>
	</ul>
  </div>
	...
	<div class="layui-side-scroll">
	  ...
	  <ul class="layui-nav layui-nav-tree"  lay-filter="test">
		<li class="layui-nav-item layui-nav-itemed">
		  <a class="" href="javascript:;">待选功能</a>
		  <dl class="layui-nav-child">
		...
		<li class="layui-nav-item"><a href={{ url_for('weather') }}>每日天气</a></li>

		<li class="layui-nav-item"><a href={{ url_for('blog') }}>社区论坛</a></li>
	  </ul>
	</div>
  </div>

  <div class="layui-body">
	<div style="padding: 288px;">
        欢迎 教师 {{ session.get('username') }} 登录教务系统
	</div>
  </div>

  <div class="layui-footer">
	<!-- 底部固定区域 -->
	© Jipeng Qian Group 2019 - Powered by Layui
  </div>
</div>
